class_name EnemyBridge extends CharacterBody2D
...
var combo_actions = [
	ComboAction.new("spawn", 0.5, "spawn", State.SPAWN),
	ComboAction.new("attack_2", 1.0, "attack_2", State.ATTACK),
	ComboAction.new("spawn", 0.5, "spawn", State.SPAWN),
	ComboAction.new("attack_2", 1.0, "attack_2", State.ATTACK),
	ComboAction.new("spawn", 0.5, "spawn", State.SPAWN),
	ComboAction.new("attack_1", 2.0, "attack_1", State.ATTACK),
	ComboAction.new("spawn", 0.5, "spawn", State.SPAWN),
